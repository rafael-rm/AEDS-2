/*
6. Considere uma lista contendo números inteiros positivos. Faça uma função
que retorne quantos números pares existem na lista.
7. Considere uma lista contendo números inteiros positivos. Faça uma função
que retorne uma nova lista contendo apenas os números pares da lista.
8. Fazer uma função para verificar se uma lista está ordenada ou não (a ordem
