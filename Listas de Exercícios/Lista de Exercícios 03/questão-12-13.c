/*
12. Escreva uma função que crie uma lista encadeada a partir de um vetor.

2

13. Escreva uma função que inverte a ordem das células de uma lista encadeada
(a primeira passa a ser última, segunda passa a ser penúltima etc.). Faça isso
