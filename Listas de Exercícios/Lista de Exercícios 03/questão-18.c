/*
18. Faça uma função remove que removerá um elemento recebifo por parâmetro
de modo que a lista estática continue ordenada. OBS: Terá que fazer o
deslocamento dos dados no vetor.
*/
